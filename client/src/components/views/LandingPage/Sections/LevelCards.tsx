  ...
  return (
    <>
      <a href={`/game/${props.levelInfo.level}`} className="m-5">
        <div className={"aspect-square  justify-center rounded-xl shadow-lg bg-white " + props.levelInfo.color + "  max-w-md "}>
          <img className="rounded-t-lg" src={props.levelInfo.image} alt="easy" />
          <div className="p-3">
